"""End-to-end tests for AllowList/DenyList logic using the new ListRule."""
import uuid
...
def test_list_rule_allowlist_behavior(client: TestClient):
...
def test_list_rule_case_insensitive(client: TestClient):
...
def test_list_rule_list_input_any_match(client: TestClient):
...
def test_list_rule_disallow_name(client: TestClient):
