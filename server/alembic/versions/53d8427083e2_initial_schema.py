"""
Revision ID: 53d8427083e2
Revises: 
Create Date: 2026-02-26 13:37:17.726678
...
def upgrade() -> None:
    ...
    op.create_table('control_execution_events',
    sa.Column('control_execution_id', sa.String(length=36), nullable=False),
    sa.Column('timestamp', sa.DateTime(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('agent_uuid', sa.UUID(), nullable=False),
    sa.Column('data', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    sa.PrimaryKeyConstraint('control_execution_id')
    )
    op.create_index('ix_events_agent_time', 'control_execution_events', ['agent_uuid', sa.literal_column('timestamp DESC')], unique=False)
