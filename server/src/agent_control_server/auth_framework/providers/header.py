...
DEFAULT_OPERATION_ACCESS: dict[Operation, AccessLevel] = {
    ...
    Operation.AGENTS_RECOVER: AccessLevel.ADMIN,
    Operation.AGENT_CONTROL_ASSOCIATIONS_WRITE: AccessLevel.ADMIN,
    Operation.AGENT_POLICY_ASSOCIATIONS_WRITE: AccessLevel.ADMIN,
