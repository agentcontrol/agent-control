"""Configuration for the budget rule."""

from __future__ import annotations

from typing import Literal

from agent_control_rules._base import RuleConfig
...
class BudgetLimitRule(RuleConfig):
    ...
    rule checks all of them and triggers on the first breach.
...
class BudgetRuleConfig(RuleConfig):
    """Configuration for the budget rule.
    ...
    def require_pricing_for_cost_rules(self) -> BudgetRuleConfig:
