"""Direct Galileo Luna rule implementation."""
...
def _resolve_package_version() -> str:
    ...
    try:
        return version("agent-control-rule-galileo")
...
@register_rule
class LunaRule(Rule[LunaRuleConfig]):
    """Galileo Luna rule using the direct scorer invocation API."""
    ...
    def __init__(self, config: LunaRuleConfig) -> None:
        """Initialize the direct Luna rule.

        Args:
            config: Validated LunaRuleConfig instance.
    ...
    async def evaluate(self, data: Any) -> RuleResult:
        ...
        Returns:
            RuleResult with local threshold decision and scorer metadata.
        """
