"""JSON validation rule with schema, type, required field, constraint, and pattern checks."""
...
from agent_control_rules.json.config import JSONRuleConfig


@register_rule
class JSONRule(Rule[JSONRuleConfig]):
    """Comprehensive JSON validation rule.
    ...
    def __init__(self, config: JSONRuleConfig) -> None:
    ...
    def _handle_parse_error(self, error: str) -> RuleResult:
    ...
    def _check_schema(self, data: dict | list) -> RuleResult | None:
    ...
    def _check_types(self, data: dict | list) -> RuleResult | None:
    ...
    def _check_required(self, data: dict | list) -> RuleResult | None:
    ...
    def _check_constraints(self, data: dict | list) -> RuleResult | None:
    ...
    def _check_patterns(self, data: dict | list) -> RuleResult | None:
