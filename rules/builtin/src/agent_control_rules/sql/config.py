"""Configuration for SQL validation rule."""
...
class SQLRuleConfig(RuleConfig):
    """Configuration for comprehensive SQL control rule.
    ...
    def validate_config(self) -> "SQLRuleConfig":
