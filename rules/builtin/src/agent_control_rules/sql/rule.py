"""Comprehensive SQL validation rule.
...
@register_rule
class SQLRule(Rule[SQLRuleConfig]):
    """Comprehensive SQL validation rule.
    ...
    def __init__(self, config: SQLRuleConfig) -> None:
    ...
    def _check_multi_statements(
        ...
        Returns:
            RuleResult if multi-statement rules are violated, None otherwise
        """
    ...
    def _check_limits(
        ...
        Returns:
            RuleResult if LIMIT rules are violated, None otherwise
        """
    ...
    def _check_complexity(
        ...
        Returns:
            RuleResult if complexity limits are violated, None otherwise
        """
        for analysis in analyses:
    ...
    async def evaluate(self, data: Any) -> RuleResult:
        ...
        Returns:
            RuleResult with matched=True if any control triggers
        """
        try:
            ...
            return RuleResult(
                matched=False,
                confidence=0.0,
                message="SQL rule encountered an unexpected error",
                error=f"{type(e).__name__}: {str(e)[:200]}",
            )

    def _evaluate_sync(self, data: Any) -> RuleResult:
        ...
        try:
            ...
            # Invalid SQL fails validation (not a rule error, just bad input)
            return RuleResult(
                matched=True,
                confidence=1.0,
    ...
    def _check_operations(
        ...
        Returns:
            RuleResult if operations violate rules, None otherwise
        """
    ...
    def _check_tables(
        ...
        Returns:
            RuleResult if tables violate rules, None otherwise
        """
    ...
    def _check_columns(
        ...
        Returns:
            RuleResult if required columns are missing, None otherwise
        """
