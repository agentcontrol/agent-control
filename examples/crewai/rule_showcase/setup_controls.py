"""
Setup script for the CrewAI Rule Showcase.

Creates controls using ALL four built-in rules in a realistic
...
async def setup():
    async with AgentControlClient(base_url=SERVER_URL) as client:
            ...
            try:
                ...
                if "409" in str(e):
                    ...
                    if clist["controls"]:
                        ...
                        print(f"  [{rule:5s}|EXIST] Already exists: {name} (ID: {cid})")
                        control_ids.append(cid)
                else:
                    raise
        ...
        # ── Summary ─────────────────────────────────────────────────────
        print()
        print("Setup complete! Rules configured:")
        print()
        ...
        print()
        print("Run the demo:  uv run --active python -m rule_showcase.main")


if __name__ == "__main__":
    print("=" * 60)
    print("  CrewAI Data Analyst - Rule Showcase Setup")
    print("=" * 60)
    print()
    asyncio.run(setup())
