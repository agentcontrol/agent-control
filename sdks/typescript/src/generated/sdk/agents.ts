...
import { agentsAssignPolicy } from "../funcs/agents-assign-policy.js";
import { agentsDeletePolicy } from "../funcs/agents-delete-policy.js";
import { agentsGetEvaluatorSchema } from "../funcs/agents-get-evaluator-schema.js";
...
import { agentsModify } from "../funcs/agents-modify.js";
...
export class Agents extends ClientSDK {
  ...
  async modify(
    ...
    return unwrapAsync(agentsModify(
      this,
      request,
      options,
    ));
  ...
  async assignPolicy(
    ...
    return unwrapAsync(agentsAssignPolicy(
      this,
      request,
      options,
    ));
