 ...
 */
export function controlBindingsListEffectiveTargetControls(
  ...
  Result<
    models.EffectiveTargetControlsResponse,
...
> {
  ...
  const path = pathToFunc("/api/v1/control-bindings/effective")();
  ...
  const context = {
    ...
    operationID:
      "list_effective_target_controls_api_v1_control_bindings_effective_get",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.EffectiveTargetControlsResponse$inboundSchema),
