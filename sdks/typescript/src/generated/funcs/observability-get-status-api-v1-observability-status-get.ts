 ...
 */
export function observabilityGetStatusApiV1ObservabilityStatusGet(
...
> {
  const path = pathToFunc("/api/v1/observability/status")();
  ...
  const context = {
    ...
    operationID: "get_status_api_v1_observability_status_get",
    oAuth2Scopes: null,
