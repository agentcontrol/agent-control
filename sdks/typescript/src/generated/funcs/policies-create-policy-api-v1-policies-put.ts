 ...
 */
export function policiesCreatePolicyApiV1PoliciesPut(
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.CreatePolicyRequest$outboundSchema, value),
  ...
  const context = {
    ...
    operationID: "create_policy_api_v1_policies_put",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CreatePolicyResponse$inboundSchema),
