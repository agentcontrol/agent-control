 ...
 */
export function controlsSetControlDataApiV1ControlsControlIdDataPut(
  client: AgentControlSDKCore,
  request: operations.SetControlDataApiV1ControlsControlIdDataPutRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.SetControlDataResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .SetControlDataApiV1ControlsControlIdDataPutRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.SetControlDataResponse$inboundSchema),
