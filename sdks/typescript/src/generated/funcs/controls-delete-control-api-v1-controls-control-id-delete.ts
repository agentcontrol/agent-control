 ...
 */
export function controlsDeleteControlApiV1ControlsControlIdDelete(
  client: AgentControlSDKCore,
  request: operations.DeleteControlApiV1ControlsControlIdDeleteRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.DeleteControlResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .DeleteControlApiV1ControlsControlIdDeleteRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "delete_control_api_v1_controls__control_id__delete",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DeleteControlResponse$inboundSchema),
