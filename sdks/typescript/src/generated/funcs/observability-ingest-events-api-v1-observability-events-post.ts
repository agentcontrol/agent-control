 ...
 */
export function observabilityIngestEventsApiV1ObservabilityEventsPost(
  client: AgentControlSDKCore,
  request: models.BatchEventsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.BatchEventsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.BatchEventsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/observability/events")();
  ...
  const context = {
    ...
    operationID: "ingest_events_api_v1_observability_events_post",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, models.BatchEventsResponse$inboundSchema),
