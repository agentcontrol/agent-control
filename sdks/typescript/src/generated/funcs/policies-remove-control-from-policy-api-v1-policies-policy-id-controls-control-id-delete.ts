 ...
 */
export function policiesRemoveControlFromPolicyApiV1PoliciesPolicyIdControlsControlIdDelete(
...
> {
  ...
  const path = pathToFunc("/api/v1/policies/{policy_id}/controls/{control_id}")(
    pathParams,
  );
