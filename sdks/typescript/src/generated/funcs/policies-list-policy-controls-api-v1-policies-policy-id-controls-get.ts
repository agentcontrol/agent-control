 ...
 */
export function policiesListPolicyControlsApiV1PoliciesPolicyIdControlsGet(
  client: AgentControlSDKCore,
  request: operations.ListPolicyControlsApiV1PoliciesPolicyIdControlsGetRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GetPolicyControlsResponse,
...
> {
  ...
  const path = pathToFunc("/api/v1/policies/{policy_id}/controls")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetPolicyControlsResponse$inboundSchema),
