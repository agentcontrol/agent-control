 ...
 */
export function controlsGetControlApiV1ControlsControlIdGet(
  client: AgentControlSDKCore,
  request: operations.GetControlApiV1ControlsControlIdGetRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GetControlResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetControlApiV1ControlsControlIdGetRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetControlResponse$inboundSchema),
