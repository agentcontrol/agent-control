...
> {
  ...
  const path = pathToFunc(
    "/api/v1/targets/{target_type}/{external_id}/controls/{control_id}",
  )(pathParams);
  ...
  const context = {
    ...
    operationID:
      "put_target_control_by_natural_key_api_v1_targets__target_type___external_id__controls__control_id__put",
    oAuth2Scopes: null,
