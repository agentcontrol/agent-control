...
# Start PostgreSQL database from the repo root
...
# If auth is enabled, this setup step needs an admin API key.
# Repo-root docker-compose default:
# export AGENT_CONTROL_API_KEY=29af8554a1fe4311977b7ce360b20cc3
uv run setup.py
```
